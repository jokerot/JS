...
export const sampleInput = `Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
...
export const realInput = `Valve EJ has flow rate=25; tunnel leads to valve MC
